	...
	class TIELABS_STYLES {
	  ...
	  */
		...
		public static function bg_image_css( $background_image = false ){
			...
			// ==1 to avoid an issue with the importer when it failed to import the background image
			if( empty( $background_image ) || empty( $background_image['img'] ) || ( ! empty( $background_image['img'] ) && $background_image['img'] == 1 ) ){
				return;
			}
