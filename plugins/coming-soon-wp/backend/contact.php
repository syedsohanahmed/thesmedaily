...
<table class="form-table">
		...
		<tr class="radio-span">
			<td>	
				<input type="text" class="pro_text" id="dazz_cs_address" name="dazz_cs_address" placeholder="<?php _e('Enter your Address','DAZZ_CSW_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_attr($dazz_cs_contact['dazz_cs_address']); ?>" />
			</td>
		</tr>
		<tr>
		...
		<tr class="radio-span">
			<td>		
				<input type="text" class="pro_text" id="dazz_cs_no" name="dazz_cs_no" placeholder="<?php _e('Enter your contact No.','DAZZ_CSW_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_attr($dazz_cs_contact['dazz_cs_no']); ?>" />
			</td>			
		</tr>
		...
		<tr class="radio-span">
			<td>	
				<input type="text" class="pro_text" id="dazz_cs_email" name="dazz_cs_email" placeholder="<?php _e('Enter your contact email','DAZZ_CSW_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_attr($dazz_cs_contact['dazz_cs_email']); ?>" />
			</td>			
		</tr>
		<tr class="radio-span" >
			<td>
