...
$dazz_csp_action_nonce = wp_create_nonce("dazz_csp_action_nonce");
?>
<style>
#TB_ajaxContent{
		width:100% !important;
...
<input type="hidden" id="dazz_csp_action_nonce_input" name="dazz_csp_action_nonce_input" value="<?php echo $dazz_csp_action_nonce; ?>" />
		<div class="dazz_detail_hi ">
			<div class="texture-layer">
				
					<div class="dazz_detail_hb"><a class="btn btn-danger btn-lg " href="https://wpshopmart.com/plugins/coming-soon-pro/" target="_blank">Buy Coming Soon Pro Now</a><a class="btn btn-success btn-lg " href="http://wpshopmart.com/coming-soon-pro-demo-page/" target="_blank">View Demo</a></div>
