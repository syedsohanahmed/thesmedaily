...
<Script>
	...
	jQuery(function() {
		...
		jQuery( "#button-size-slider" ).slider("value",<?php if($dazz_cs_design['dazz_headline_ft_size']!=""){ echo  esc_attr($dazz_cs_design['dazz_headline_ft_size']); } else { echo "18"; }?>  );
...
<Script>
	...
	jQuery( "#button-size-slider3" ).slider("value",<?php if($dazz_cs_design['dazz_desc_ft_size']!=""){ echo esc_attr($dazz_cs_design['dazz_desc_ft_size']); } else { echo "16"; }?> );
...
<table class="form-table">
	...
	<tr class="radio-span" >
		<td>
			...
			<input id="dazz_cs_bg_clr" name="dazz_cs_bg_clr" type="text" value="<?php echo esc_attr($dazz_cs_design['dazz_cs_bg_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
	...
	<tr class="radio-span" >
		<td>
				...
				<img src="<?php echo esc_url($dazz_cs_design['dazz_cs_bg_img']); ?>" class="csw-admin-img" />
				
				<input type="button" id="upload-background" name="upload-background" value="Upload Image" class="button-primary rcsp_media_upload"  />
				<input type="hidden" id="dazz_cs_bg_img" name="dazz_cs_bg_img" class="rcsp_label_text"  value="<?php echo esc_url($dazz_cs_design['dazz_cs_bg_img']); ?>"  readonly="readonly" placeholder="No Media Selected" />
	...
	<tr class="radio-span" >
		<td>
			...
			<input id="dazz_headeline_ft_clr" name="dazz_headeline_ft_clr" type="text" value="<?php echo esc_attr($dazz_cs_design['dazz_headeline_ft_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
	...
	<tr class="radio-span" >
		<td>
			...
			<input id="dazz_desc_ft_clr" name="dazz_desc_ft_clr" type="text" value="<?php echo esc_attr($dazz_cs_design['dazz_desc_ft_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
	...
	<tr class="radio-span" >
		<td>
			...
			<input id="dazz_social_clr" name="dazz_social_clr" type="text" value="<?php echo esc_attr($dazz_cs_design['dazz_social_clr']); ?>" class="my-color-field" data-default-color="#ffffff" />
...
<tr>
	...
	<tr class="radio-span" >
		<td>
				<textarea rows="6"  class="pro_text" id="dazz_cs_custom_css" name="dazz_cs_custom_css" placeholder="<?php _e('Enter Your custom css Here',''); ?>"><?php echo esc_textarea(stripslashes($dazz_cs_design['dazz_cs_custom_css'])); ?></textarea>
...
function dazz_save_data_design(){
	...
	var dazz_csp_action_nonce_input = jQuery("#dazz_csp_action_nonce_input").val();
 	...
 	jQuery.ajax(
            {
				...
				'dazz_csp_action_nonce_input':dazz_csp_action_nonce_input,
...
<?php
if(isset($_POST['dazz_csp_action_nonce_input'])) 
{
	if ( wp_verify_nonce( $_POST['dazz_csp_action_nonce_input'], 'dazz_csp_action_nonce' ) )
	{

if(isset($_POST['action_design'])=="dazz_csp_design") {
$dazz_cs_select_bg       =  sanitize_text_field($_POST['dazz_cs_select_bg']);
...
$dazz_cs_custom_css          = wp_kses_post($_POST['dazz_cs_custom_css']);
