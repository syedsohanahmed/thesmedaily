...
<table class="form-table">
		...
		<tr class="radio-span" >
			<td>
				...
				<input type="text" class="pro_text" id="dazz_cs_fb" name="dazz_cs_fb" placeholder="<?php _e('Enter Facebook profile url','DAZZ_CSW_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_url($dazz_cs_social['dazz_cs_fb']); ?>" />
		...
		<tr class="radio-span" >
			<td>
				...
				<input type="text" class="pro_text" id="dazz_cs_twit" name="dazz_cs_twit" placeholder="<?php _e('Enter Twitter profile url','DAZZ_CSW_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_url($dazz_cs_social['dazz_cs_twit']); ?>" />
		...
		<tr class="radio-span" >
			<td>
				...
				<input type="text" class="pro_text" id="dazz_cs_ln" name="dazz_cs_ln" placeholder="<?php _e('Enter LinkedIn profile url','DAZZ_CSW_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_url($dazz_cs_social['dazz_cs_ln']); ?>" />
		...
		<tr class="radio-span" >
			<td>
				...
				<input type="text" class="pro_text" id="dazz_cs_gp" name="dazz_cs_gp" placeholder="<?php _e('Enter Google Plus profile url ','DAZZ_CSW_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_url($dazz_cs_social['dazz_cs_gp']); ?>" />
