...
<table class="form-table">
	...
	<tr class="radio-span" >
		<td>
				...
				<img src="<?php echo esc_url($dazz_cs_seo['dazz_cs_favicon']); ?>" class="csw-admin-img" />
				
				<input type="button" id="upload-background" name="upload-background" value="Upload Image" class="button-primary rcsp_media_upload"  />
				<input type="hidden" id="dazz_cs_favicon" name="dazz_cs_favicon" class="rcsp_label_text"  value="<?php echo esc_url($dazz_cs_seo['dazz_cs_favicon']); ?>"  readonly="readonly" placeholder="No Media Selected" />
	...
	<tr class="radio-span" >
		<td>
				<input type="text" class="pro_text" id="dazz_cs_seo_title" name="dazz_cs_seo_title" placeholder="<?php _e('Enter Your SEO Title Here...','DAZZ_CSW_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_attr($dazz_cs_seo['dazz_cs_seo_title']); ?>" />
	...
	<tr class="radio-span" >
		<td>
				<textarea rows="6"  class="pro_text" id="dazz_cs_seo_desc" name="dazz_cs_seo_desc" placeholder="<?php _e('Enter Your SEO Description Here...','DAZZ_CSW_TEXT_DOMAIN'); ?>"><?php echo esc_attr($dazz_cs_seo['dazz_cs_seo_desc']); ?></textarea>
	...
	<tr class="radio-span" >
		<td>
				<textarea rows="6"  class="pro_text" id="dazz_cs_seo_analytics" name="dazz_cs_seo_analytics" placeholder="<?php _e('Enter Your Google Analytics Script Here','DAZZ_CSW_TEXT_DOMAIN'); ?>"><?php echo esc_textarea(stripslashes($dazz_cs_seo['dazz_cs_seo_analytics'])); ?></textarea>
...
$dazz_cs_seo_title          = wp_kses_post(sanitize_text_field($_POST['dazz_cs_seo_title']));
$dazz_cs_seo_desc          = wp_kses_post($_POST['dazz_cs_seo_desc']);
$dazz_cs_seo_analytics          = wp_kses_post($_POST['dazz_cs_seo_analytics']);
