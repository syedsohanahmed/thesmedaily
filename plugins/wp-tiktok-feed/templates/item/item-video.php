<div class="tiktok-feed-video-wrap">
  <a class="tiktok-feed-link" href="<?php echo esc_url($item['link']); ?>" target="_blank">
    <img width="<?php echo $item['width']; ?>" height="<?php echo $item['height']; ?>" alt="TikTok" class="tiktok-feed-video" <?php echo($feed['lazy']) ? 'loading="lazy"' : ''; ?> src="<?php echo esc_url($image); ?>"/>
