...
<div tabindex="0" id="<?php echo esc_attr(QLTTF_PREFIX . '_modal'); ?>" class="media-modal qlttf-modal-feed wp-core-ui upload-php processing" role="dialog" aria-modal="true" aria-labelledby="media-frame-title">
    ...
    <form class="media-modal-form" method="POST">
      ...
      <div class="edit-attachment-frame mode-select hide-menu hide-router">
        ...
        <div class="media-frame-title">
          <h1><?php esc_html_e('Edit feed', 'wp-tiktok-feed'); ?> # <# if ( data.id != undefined ) { #>{{data.id}}<# } else { #><?php echo esc_html_e('New', 'wp-tiktok-feed'); ?><# } #></h1>
        </div>
            ...
            <div class="attachment-media-view landscape">
              <div id="woocommerce-product-data" style="height:100%;">
                <div class="panel-wrap" style="height:100%;">
                  <div id="qlttf-modal-tabs">
                  </div>
                  <div id="qlttf-modal-panels" style="height: 100%;overflow-x: hidden;">
                  </div>
                </div>
              </div>
            </div>
